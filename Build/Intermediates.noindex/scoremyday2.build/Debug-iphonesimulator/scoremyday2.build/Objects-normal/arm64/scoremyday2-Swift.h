...
#ifndef SCOREMYDAY2_SWIFT_H
#define SCOREMYDAY2_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="scoremyday2",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@property (nonatomic) int16_t polarityRaw;
@property (nonatomic) int16_t unitTypeRaw;
@property (nonatomic, copy) NSString * _Nonnull unitLabel;
...
@property (nonatomic, strong) DeedCardMO * _Nonnull deed;
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

@class NSCoder;
SWIFT_CLASS("_TtC11scoremyday221ParticleOverlayUIView")
